                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="phone_leaser_two" id="phone_leaser_two" class="form-control" placeholder="Ej: 948992070" autocomplete="none" maxlength="9" required>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="modalEditLeaser" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                        <button id="btnEdit" type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i> Editar</button>
                    </div>
                    </form>
                </div>
            </div>
