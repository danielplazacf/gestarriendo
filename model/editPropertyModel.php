<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        SET agent_designated = '$agent', type_property = '$type', address_property = '$address', n_client_agua = '$client_agua', n_client_luz = '$client_luz', n_client_gas = '$client_gas', last_date = '$date'
